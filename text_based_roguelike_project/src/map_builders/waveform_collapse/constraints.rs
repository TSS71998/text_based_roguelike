use super::{Map, TileType, MapChunk, tile_idx_in_chunk};
use std::collections::HashSet;

pub fn build_patterns(map: &Map, chunk_size: i32, including_flipping: bool, dedupe: bool) -> Vec<Vec<TileType>> {
