...
impl DrunkardsWalkBuilder {
    ...
    pub fn winding_passage(new_depth: i32) -> DrunkardsWalkBuilder {
        DrunkardsWalkBuilder{
            map: Map::new(new_depth),
            starting_position: Position { x: 0, y: 0 },
            depth: new_depth,
    ...
    fn build(&mut self) {
        ...
        rltk::console::log(format!("{} dwarves gave up their sobriety, of whom {} found a wall.", digger_count, active_digger_count));
