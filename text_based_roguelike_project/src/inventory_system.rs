use specs::prelude::*;
use super::{WantsToPickupItem, Name, InBackpack, Position, gamelog::GameLog, WantsToDrinkPotion, CombatStats, Potion, WantsToDropItem};
        ...
        for(entity, drink, stats) in (&entities, &wants_drink, &mut combat_stats).join() {
            ...
            match potion {
                ...
                Some(potion) => {
                    ...
                    entities.delete(drink.potion).expect("Deleted Failed");
                }
            }
        }
        wants_drink.clear();
